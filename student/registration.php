...
<body class="login" style="margin-top: -20px;">
                ...
                if(isset($_POST["submit1"]))
			{
			   ...
			   $link=mysqli_connect("localhost","root","");
				mysqli_select_db($link,"lms");
					...
					mysqli_query($link,"insert into s_registration values('','$_POST[firstname]','$_POST[lastname]','$_POST[username]','$_POST[password]','$_POST[email]','$_POST[contact]','$_POST[sem]','$_POST[enrollmentno]','no')");
    ...
    <div class="alert alert-success col-lg-6 col-lg-push-3">
        Registration successfully, You will get email wen your account is approved
    </div>
